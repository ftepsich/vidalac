...
return {
xtype: 'form',
url : '/Facturacion/ReporteRecibos/verreporte',
layout: 'form',
border: false,
...
}, 
{
    ...
    store:new Ext.data.JsonStore({
       id:0,
       url:"datagateway\/combolist\/model\/Clientes\/m\/Base\/search\/RazonSocial",
...
action: 'launch',
url: '/Facturacion/ReporteRecibos/verreporte'+params,
width: 900,
height: 500,
