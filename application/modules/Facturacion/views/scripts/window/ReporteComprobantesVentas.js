...
Apps.<?=$this->name?> = Ext.extend(RadDesktop.Module, {
    ...
    renderWindowContent: function ()
    {
        return {
            xtype: 'form',
            url : '/Facturacion/ReporteComprobantesVentas/verreporte',
            layout: 'form',
            border: false,
            ...
            buttons:[
                {
                    ...
                    handler: function () {
                        ...
                        app.publish('/desktop/modules/js/commonApps/showUrl.js', {
                            action: 'launch',
                            url: '/Facturacion/ReporteComprobantesVentas/verreporte'+params,
                            width: 900,
                            height: 500,
                            title: 'Reporte de Comprobantes de Ventas'
                        });
                    }
                }
            ]
