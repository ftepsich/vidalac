...
Apps.<?=$this->name?> = Ext.extend(RadDesktop.Module, {
        ...
        this.orden = new Ext.ux.form.ComboBox({
            ...
            store: new Ext.data.ArrayStore({
                ...
                data : [
                    ...
                    ['Condicion Compra, Fecha y Nro Comprobante', '5'],
                    ['Condicion Compra y Nro Comprobante', '6'],
                    ['Libro de IVA, Fecha y Nro Comprobante', '7'],
                    ['Libro de IVA y Nro Comprobante', '8']
                ]
            })
        });
    ...
    renderWindowContent: function ()
    {
        return {
            xtype: 'form',
            url : '/Facturacion/ReporteComprobantesCompras/verreporte',
            layout: 'form',
            border: false,
            ...
            buttons:[
                {
                    ...
                    handler: function () {
                        ...
                        if (values.condCompra != '') {
                            params += '/condCompra/'+values.condCompra;
                        }
                        ...
                        app.publish('/desktop/modules/js/commonApps/showUrl.js', {
                            action: 'launch',
                            url: '/Facturacion/ReporteComprobantesCompras/verreporte'+params,
                            width: 900,
                            height: 500,
                            title: 'Reporte de Comprobantes de Compras'
                        });
                    }
                }
            ]
