...
/**
 * Facturacion_ReporteOrdenesDePagosController
 *
 * 
 *
 * 
 * @package Aplicacion
 * 
 * @class Facturacion_ReporteOrdenesDePagosController
 * @extends Rad_Window_Controller_Action
 */
class Facturacion_ReporteOrdenesDePagosController extends Rad_Window_Controller_Action
{
    ...
    public function verreporteAction ()
    {
        ...
        $file  = APPLICATION_PATH . '/../birt/Reports/Reporte_OrdenesDePagos.rptdesign';
