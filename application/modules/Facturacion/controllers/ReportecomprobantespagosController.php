...
/**
 * Facturacion_ReporteComprobantesPagosController
 *
 ...
 * @package Aplicacion
 * @subpackage Base
 * @class Facturacion_ReporteComprobantesPagosController
 * @extends Rad_Window_Controller_Action
 */
class Facturacion_ReportecomprobantespagosController extends Rad_Window_Controller_Action
{
    protected $title = 'Reporte de Ordenes de Pagos';
    ...
    protected function buildWhere($param)
    {
        ...
        // OP: 9
        // Recibo: 11
        $where[] = 'T.Grupo in (9) and ifnull(C.Anulado,0) <> 1 and C.Cerrado = 1';
    ...
    public function verreporteAction ()
    {
        ...
        $texto = 'Reporte de Ordenes de Pago'. $texto;
