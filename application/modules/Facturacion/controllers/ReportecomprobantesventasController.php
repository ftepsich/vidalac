 ...
 */
class Facturacion_ReporteComprobantesVentasController extends Rad_Window_Controller_Action
{
    protected $title = 'Reporte de Comrpbantes de Ventas';
    ...
    protected function buildWhere($param)
    {
        ...
        // FV 6 - NDE 12 - NCR 8
        // FC 1 - NCE 7 - NDR 13
        $where[] = 'T.Grupo in (6,8,12) and ifnull(C.Anulado,0) <> 1 and C.Cerrado = 1';
    ...
    public function verreporteAction ()
    {
        ...
        $texto = 'Reporte de Comprobantes de Venta'. $texto;
