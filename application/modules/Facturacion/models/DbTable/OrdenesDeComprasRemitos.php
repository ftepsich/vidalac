...
/**
 * Ordenes de compras Remitos
 *
 *
 * @class 		Facturacion_Model_DbTable_OrdenesDeComprasRemitos
 * @extends		Facturacion_Model_DbTable_ComprobantesRelacionados
 * @package 	Aplicacion
 * @subpackage 	Facturacion
 *
 */
class Facturacion_Model_DbTable_OrdenesDeComprasRemitos extends Facturacion_Model_DbTable_ComprobantesRelacionados
{
  ...
  protected $_referenceMap    = array(
     ...
     * el Remito a lo disponible en la Orden de Compra
     *
     * @param array $data
     * @return mixed
     */
    public function insert($data) {
        ...
        try {
            ...
            $M_H = new Facturacion_Model_DbTable_OrdenesDeCompras(array(), false);
