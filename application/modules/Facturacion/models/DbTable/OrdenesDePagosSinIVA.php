...
/**
 * @class               Facturacion_Model_DbTable_OrdenesDePagosSinIVA
 ...
 *
 */
class Facturacion_Model_DbTable_OrdenesDePagosSinIVA extends Facturacion_Model_DbTable_ComprobantesPagos
{
    ...
    protected $_validators = array(
        'Numero' => array(
            ...
            'messages' => array(
                ...
                'El numero %value% ya existe para ese proveedor'
            )
        ),
        'ValorDivisa' => array(
            array('GreaterThan', 0),
    ...
    protected $_referenceMap = array(
        ...
        'TiposDeComprobantes' => array(
            ...
            'comboBox' => true,
            'comboSource' => 'datagateway/combolist/fetch/EsOrdenDePagoSinIva',
            'refTable' => 'TipoDeComprobante',
            'refColumns' => 'Id'
        )
    );
    // fin  protected $_referenceMap -----------------------------------------------------------------------------
    protected $_dependentTables = array("Facturacion_Model_DbTable_OrdenesDePagosSinIVADetalles");
    ...
    public function init()
    {
        ...
        $this->_defaultValues['TipoDeComprobante'] = 69; 
    ...
    public function insert($data)
    {
	    ...
	    $data['TipoDeComprobante'] = $TipoDeComprobante;
            ...
            if (!$data['PeriodoImputacionSinIVA']) {
                $data['PeriodoImputacionSinIVA'] = $this->seleccionarPeriodoImputacionSinIVA($data['FechaEmision']);
            }
