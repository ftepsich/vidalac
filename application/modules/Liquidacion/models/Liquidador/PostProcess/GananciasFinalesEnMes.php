...
class Liquidacion_Model_Liquidador_PostProcess_GananciasFinalesEnMes extends Liquidacion_Model_Liquidador_PostProcess
{
        ...
        */
        ...
        $where = "		Ajuste 		= 0 
        			...
        			and Servicio in (	Select 	Id 
        								...
        								and 	ifnull(GananciaAlBajar,1) = 3 
        ...
        if ($R_LR) {
            $M_PGLM  = new Rrhh_Model_DbTable_PersonasGananciasLiquidacionesAjustesAunMes;
            ...
            foreach ($R_LR as $row) {
                ...
                echo "-- Por entrar a generarAjusteGananciasAunMes($anio,$mes,$idPersona,$liquidacionId,$idRecibo)".PHP_EOL;
                $M_PGLM->generarAjusteGananciasAunMes($anio,$mes,$idPersona,$liquidacionId,$idRecibo);
