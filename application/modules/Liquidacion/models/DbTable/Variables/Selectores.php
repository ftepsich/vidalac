...
/**
 * Liquidacion_Model_DbTable_Variables_Selectores
 *
 * Selectores
 *
 ...
 * @class Liquidacion_Model_DbTable_Variables_Selectores
 * @extends Liquidacion_Model_DbTable_VariablesAbstractas
 */
class Liquidacion_Model_DbTable_Variables_Selectores extends Liquidacion_Model_DbTable_VariablesAbstractas
{
    ...
    protected $_permanentValues  = array( 'TipoDeVariable' => 5);
    protected $_defaultValues    = array( 'TipoDeVariable' => 5);
