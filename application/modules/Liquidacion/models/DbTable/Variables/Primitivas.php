...
/**
 * Liquidacion_Model_DbTable_Variables_Primitivas
 *
 * Primitivas
 *
 ...
 * @class Liquidacion_Model_DbTable_Variables_Primitivas
 * @extends Liquidacion_Model_DbTable_VariablesAbstractas
 */
class Liquidacion_Model_DbTable_Variables_Primitivas extends Liquidacion_Model_DbTable_VariablesAbstractas
{
    ...
    protected $_permanentValues  = array( 'TipoDeVariable' => 4);
    protected $_defaultValues    = array( 'TipoDeVariable' => 4);
