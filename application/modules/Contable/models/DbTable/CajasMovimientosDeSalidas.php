...
/**
 * Contable_DbTable_CajasMovimientosDeSalidas
 *
 ...
 * @subpackage Contable
 */
class Contable_Model_DbTable_CajasMovimientosDeSalidas extends Contable_Model_DbTable_CajasMovimientos
{
    protected $_permanentValues = array(
        'TipoDeMovimiento'  => 3,
        'Descripcion'       => 'Extraccion de dinero'
    );
