 ...
 */
class Rrhh_Model_DbTable_PersonasGananciasLiquidacionesAjustesAunMes extends Rrhh_Model_DbTable_PersonasGananciasLiquidaciones
{
    ...
    */
    public function generarAjusteGananciasAunMes($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {
        // Armo el mes 13 con el acumulado anual

        $this->delGananciaAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo);
        ...
        $this->setIngresoBrutoAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo);

        // seteo los descuentos del Recibo de Sueldo
        echo '.....'.PHP_EOL.'.....'.PHP_EOL.'..... setDeduccionesRecibosPropiosAnual'.PHP_EOL.'.....'.PHP_EOL.'.....'.PHP_EOL;
        $this->setDeduccionesRecibosPropiosAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo);

        // seteo los valores de Recibos de Terceros
        echo '.....'.PHP_EOL.'.....'.PHP_EOL.'..... setDeduccionesRecibosTercerosAnual'.PHP_EOL.'.....'.PHP_EOL.'.....'.PHP_EOL;
        $this->setDeduccionesRecibosTercerosAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo);
        ...
        $this->setDeduccionesPersonalesAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo);

        // seteo los ajustes personales (presentadas en el 572)
        echo '.....'.PHP_EOL.'.....'.PHP_EOL.'..... setAjustesPersonalesAnual'.PHP_EOL.'.....'.PHP_EOL.'.....'.PHP_EOL;
        $this->setAjustesPersonalesAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo);

        // seteo las deducciones personales (presentadas en el 572)
        echo '.....'.PHP_EOL.'.....'.PHP_EOL.'..... setPagosyDevolucionesAnuales'.PHP_EOL.'.....'.PHP_EOL.'.....'.PHP_EOL;
        $this->setPagosyDevolucionesAnuales($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo);
    }
     ...
     * @return none
     */
    public function delGananciaAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {

        $where = "          Persona             = $idPersona
                    AND     GananciaAnioPeriodo = $anio
                    AND     GananciaMesPeriodo  = $mesBaja
                    -- AND     Recibo           = $idRecibo
                ";
     ...
     * @return  none
     */
    public function setIngresoBrutoAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {
     ...
     * @return none
     */
    public function setDeduccionesRecibosPropiosAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {
...
*/
     ...
     * @return none
     */
    public function setDeduccionesRecibosTercerosAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {

        $periodoGananciaFD  = $datos['anio']."-01-01";

        if ($mes == 12) {
            $periodoGananciaFH = "$anio-12-31";
        } else {
            $mm = $mesBaja+1;
            $periodoGananciaFH = "$anio-".$mm."-01";
            // hago así para facilitar el calculo en lugar del ultimo dia del mes tomo el primero del siguiente como limite
        }
        ...
        $sql = "SELECT  ifnull(sum(RemuneracionBrutaTotal),0)   as RemuneracionBrutaTotal,
                ...
                FROM    PersonasGananciasPluriempleoDetalle PPD
                INNER JOIN PersonasGananciasPluriempleo PGP on PGP.Id = PPD.PersonaGananciaPluriempleo
                WHERE   PPD.FechaDeLiquidacion <=   '$periodoGananciaFH'
   ...
   /**
     ...
     * @return none
     */
    public function setDeduccionesPersonalesAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {
   ...
   /**
     ...
     * @return none
     */
    public function setAjustesPersonalesAnual($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {
     ...
     * @return  decimal
     */
    public function getDescuentosQueNoSuman($idPersona,$anio,$mesBaja) {
     ...
     * @return  decimal
     */
    public function getSumDescuentos($idPersona,$anio,$mesBaja) {
     ...
     * @return  decimal
     */
    public function getSumRemunerativos($idPersona,$anio,$mesBaja,$idRecibo) {
     ...
     * @return decimal
     */
    public function getPagos($idPersona,$anio,$mesBaja,$idRecibo) {
     ...
     * @return decimal
     */
    public function getDevoluciones($idPersona,$anio,$mesBaja,$idRecibo) {
     ...
     * @return decimal
     */
    public function getMontoImponible($idPersona,$anio,$mesBaja) {
        ...
        $sql = "SELECT  sum(MontoAcumulado)
                ...
                AND     PGL.GananciaMesPeriodo  = $mesBaja
     ...
     * @return decimal
     */
    public function getAjustes($idPersona,$anio,$mesBaja) {
     ...
     * @return none
     */
    public function setPagosyDevolucionesAnuales($anio,$mesBaja,$idPersona,$idLiquidacion,$idRecibo) {
        ...
        // Devoluciones
        // *******************************************************************************************
        $devoluciones   = $this->getDevoluciones($idPersona,$anio,$mesBaja,$idRecibo);

        // *******************************************************************************************
        // Pagos
        // *******************************************************************************************
        $pagos          = $this->getPagos($idPersona,$anio,$mesBaja,$idRecibo);
        ...
        // sumado NUNCA con las deducciones por lo tanto SIEMPRE el 41 Debe esta en el not del where
        // *******************************************************************************************
        $MontoImponible = $this->getMontoImponible($idPersona,$anio,$mesBaja);

        // *******************************************************************************************
        // Ajustes
        // *******************************************************************************************
        $ajustes        = $this->getAjustes($idPersona,$anio,$mesBaja);
        ...
        // *******************************************************************************************
            ...
            $sql = "SELECT  *
                    ...
                    WHERE   Desde/12*$mesBaja < $MontoImponible
                    AND     Hasta/12*$mesBaja >= $MontoImponible";
            ...
            $limiteInferior     = $tablaAfip['Desde'] / 12 * $mesBaja;
            $Alicuota           = $tablaAfip['Alicuota'];
            $CanonFijo          = $tablaAfip['CanonFijo'];

            $montoIncremento    = (($MontoImponible - $limiteInferior) * ($Alicuota / 100))  + ($CanonFijo / 12 * $mesBaja);
