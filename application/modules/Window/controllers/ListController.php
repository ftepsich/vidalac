...
class Window_ListController extends Rad_Window_Controller_Action
{
    protected $grid       = null;
    protected $modelName  = '';
    ...
    protected function buildGrid ()
    {
        ...
        $this->grid = $this->view->radGrid($this->modelClass , $parametrosAdc , '', $this->modelIni);
    }
    ...
    {
    	return $this->_request->getControllerName().$this->modelName.$this->modelIni;
    }
