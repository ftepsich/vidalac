...
//        this.wrap = t.wrap();
	...
	,afterRender: function() {
		this.df.getEl().on('dblclick', this.onDblClick);
		this.tf.getEl().on('dblclick', this.onDblClick);
	}
...
//            this.removeAllListeners();
	...
	// {{{
	/**
	 * @private Setea fecha y hora al hacer doble click
	 */

	,onDblClick: function() {
		Ext.getCmp(this.id).ownerCt.df.setValue(new Date());
		Ext.getCmp(this.id).ownerCt.tf.setValue(new Date());
	}
